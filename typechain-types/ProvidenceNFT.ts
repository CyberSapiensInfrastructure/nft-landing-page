...
export interface ProvidenceNFTInterface extends utils.Interface {
  contractName: "ProvidenceNFT";
  functions: {
    ...
    "getRedeemCode(uint256)": FunctionFragment;
    "isApprovedForAll(address,address)": FunctionFragment;
    "mint(address,string)": FunctionFragment;
    "name()": FunctionFragment;
    "nftList(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getRedeemCode",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "nftList", values: [string]): string;
  encodeFunctionData(
...
export interface ProvidenceNFT extends BaseContract {
  contractName: "ProvidenceNFT";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProvidenceNFTInterface;
  ...
  nftList(_address: string, overrides?: CallOverrides): Promise<BigNumber[]>;
  ...
  callStatic: {
    ...
    updatePause(_newPaused: boolean, overrides?: CallOverrides): Promise<void>;
  };
