...
export const BottomSheet: React.FC<BottomSheetProps> = ({
  ...
  return (
    <motion.div
      ...
      className="fixed top-0 right-0 h-full w-full overflow-auto sm:w-[400px] bg-[#0c0c0c]/95 backdrop-blur-xl border-l border-[#a8c7fa]/10 z-[250] overflow-y-auto"
    >
      {/* Header */}
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-[#a8c7fa]/5 p-3 rounded-xl">
              <span className="block text-[#a8c7fa]/60 text-sm mb-1">
                mission
              </span>
