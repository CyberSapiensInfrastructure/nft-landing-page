...
export const NFTGrid: React.FC<NFTGridProps> = ({ nfts, isLoading, onSelect, selectedNFTId, view, onViewChange, onTabChange }) => {
  ...
  return (
    <div className="w-full h-full flex">
      ...
      {/* Mobile Filter Bar */}
      <div className="lg:hidden fixed top-[3.5rem] left-0 right-0 z-30 bg-[#0c0c0c]/95 backdrop-blur-md border-b border-[#a8c7fa]/10">
      ...
      {/* Main Content */}
      <div className={`flex-1 ${isMenuCollapsed ? 'lg:ml-[60px]' : 'lg:ml-[200px]'} min-h-screen transition-all duration-300 ${!isMenuCollapsed && 'lg:pt-0 pt-28'}`}>
        {/* Content Area */}
                  ...
                  <div className="mt-3 space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-1.5 text-xs">
                      <div className="bg-[#a8c7fa]/5 px-2 py-1.5 rounded-lg">
                        <span className="block text-[#a8c7fa]/60 mb-0.5">Mission</span>
                        <p className="text-white font-medium truncate">{nft.missionAmount}</p>
                      </div>
                      <div className="bg-[#a8c7fa]/5 px-2 py-1.5 rounded-lg">
                        <span className="block text-[#a8c7fa]/60 mb-0.5">Expires</span>
                        <p className="text-white font-medium truncate">{nft.expireDate}</p>
                      </div>
                    </div>
                  </div>
                </div>
