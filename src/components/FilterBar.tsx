    ...
    <div className="flex flex-col space-y-6">
      ...
      <div className="flex flex-wrap gap-3">
        <button
          ...
          className={`px-6 py-2.5 rounded-xl flex items-center gap-2 transition-all duration-300
            ${activeTab === 'all' 
              ? 'bg-[#7042f88b] text-white' 
              : 'bg-[#0c0c0c] hover:bg-[#7042f88b]/20 text-[#a8c7fa]/60 hover:text-white border border-[#a8c7fa]/10'
            }`}
        >
      ...
      <div className="flex flex-wrap items-center gap-4">
        ...
        <div className="relative group">
          <button className="px-6 py-2.5 bg-[#0c0c0c] hover:bg-[#0c0c0c]/80 text-white rounded-xl flex items-center gap-2 
          ...
          <div className="absolute top-full left-0 mt-2 w-full bg-[#0c0c0c] border border-[#a8c7fa]/10 rounded-xl overflow-hidden 
        ...
        <div className="relative group ml-auto">
          ...
          <div className="absolute top-full right-0 mt-2 w-48 bg-[#0c0c0c] border border-[#a8c7fa]/10 rounded-xl overflow-hidden 
                         opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
            <div className="py-1">
              {[
